class LoginsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @login.save
         Notifier.registered(@login).deliver
        format.html { redirect_to root_url, notice: 'Login was successfully created.' }
  ...
  private
    ...
    def login_params
      params.require(:login).permit(:username, :password_hash, :password_salt)
    end
