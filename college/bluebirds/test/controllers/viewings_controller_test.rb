...
class ViewingsControllerTest < ActionController::TestCase
  ...
  test "should create viewing" do
    assert_difference('Viewing.count') do
      post :create, viewing: { AudiInfo_id: @viewing.AudiInfo_id, Movie_id: @viewing.Movie_id, timing: @viewing.timing }
    end
  ...
  test "should update viewing" do
    patch :update, id: @viewing, viewing: { AudiInfo_id: @viewing.AudiInfo_id, Movie_id: @viewing.Movie_id, timing: @viewing.timing }
    assert_redirected_to viewing_path(assigns(:viewing))
  end
